define(['when', 'js-signals', 'capnp-js', 'capnp-js/nonframed', './peer.capnp.d/builders', './server.capnp.d/readers', './client.capnp.d/builders'], function (
         when,      signals,   capnp,               nonframed,     peer,                      server,                     client) {

    var allocator = new capnp.Allocator();

    var Signal = function (timeout, wssUrl) {
    ...
    Signal.prototype._reconnect = function () {
        var socket = this._socket = new WebSocket(this._wssUrl);
